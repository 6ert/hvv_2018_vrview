...
n.init=function(b,c){var d={},e=[],f=b.periods.some(function(b){return b.variants.some(function(b){return b.drmInfos.length})});this.fa=c;this.m=b.offlineSessionIds;ac(this,b,c||0<b.offlineSessionIds.length,d,e);return e.length?bc(this,d,e,f):(this.N=!0,Promise.resolve())};
...
function we(b,c,d){b=xe(b);var e=null,f=[],g=[],h=b.map(function(b){return b.keyId}).filter(Cb);if(h.length&&1<h.filter(Db).length)throw new A(2,4,4010);d||(g=b.filter(function(b){return"urn:mpeg:dash:mp4protection:2011"==b.Pc?(e=b.init||e,!1):!0}),g.length&&(f=ye(e,c,g),0==f.length&&(f=[Fb("",e)])));!b.length||!d&&g.length||(f=G(ve).filter(function(b){return"org.w3.clearkey"!=b}).map(function(b){return Fb(b,e)}));var k=h[0]||null;k&&f.forEach(function(b){b.initData.forEach(function(b){b.keyId=k})});
return{lc:k,ef:e,drmInfos:f,qc:!0}}function ze(b,c,d,e){var f=we(b,c,e);if(d.qc){b=1==d.drmInfos.length&&!d.drmInfos[0].keySystem;c=0==f.drmInfos.length;if(0==d.drmInfos.length||b&&!c)d.drmInfos=f.drmInfos;d.qc=!1}else if(0<f.drmInfos.length&&(d.drmInfos=d.drmInfos.filter(function(b){return f.drmInfos.some(function(c){return c.keySystem==b.keySystem})}),0==d.drmInfos.length))throw new A(2,4,4008);return f.lc||d.lc}
function ye(b,c,d){return d.map(function(d){var e=ve[d.Pc];return e?[Fb(e,d.init||b)]:c(d.node)||[]}).reduce(Ab,[])}
...
function Og(b){var c=Hg(b.a);0<b.c.readyState&&(b.c.paused||(c=Ng(b,c)));return c}n.Xa=function(){return this.a.Xa()};n.cb=function(){this.g.cb()};n.Ud=function(){if(0!=this.c.readyState&&!this.c.paused){var b=this.c.currentTime,c=this.b.presentationTimeline,d=c.Ka();c=c.la();3>c-d&&(d=c-3);b<d&&(b=Pg(this,b),this.c.currentTime=b)}};
n.Xd=function(){var b=this.g;b.g=!0;b.f=!1;b.c=!1;var c=Hg(this.a);b=Pg(this,c);if(.001<Math.abs(b-c)&&(c=(new Date).getTime()/1E3,!this.i||this.i<c-1)){this.i=c;Ig(this.a,b);return}this.j()};function Mg(b,c){var d=b.b.presentationTimeline.S();return c>=d?d-b.h.durationBackoff:c}
function Pg(b,c){var d=sc.bind(null,b.c.buffered),e=Math.max(b.b.minBufferTime||0,b.h.rebufferingGoal),f=b.b.presentationTimeline,g=f.Ka(),h=f.la(),k=f.S();3>h-g&&(g=h-3);var l=f.Ya(e),m=f.Ya(5);e=f.Ya(e+5);return c>=k?Mg(b,c):c>h?h:c<g?d(m)?m:e:c>=l||d(c)?c:e}function Ng(b,c){var d=b.b.presentationTimeline.Ka();if(c<d)return d;d=b.b.presentationTimeline.la();return c>d?d:c};function Qg(b,c,d,e,f,g,h){this.a=b;this.v=c;this.g=d;this.u=e;this.l=f;this.h=g;this.A=h;this.c=[];this.j=new D;this.b=!1;this.i=-1;this.f=null;Rg(this)}Qg.prototype.destroy=function(){var b=this.j?this.j.destroy():Promise.resolve();this.j=null;Sg(this);this.A=this.h=this.l=this.u=this.g=this.v=this.a=null;this.c=[];return b};
...
function Rk(b,c,d){var e,f,g;(new S).D("payl",Le(function(b){e=H(b)})).D("iden",Le(function(b){f=H(b)})).D("sttg",Le(function(b){g=H(b)})).parse(b);return e?Sk(e,f,g,c,d):null}function Sk(b,c,d,e,f){b=new I(e,f,b);c&&(b.id=c);if(d)for(c=new Of(d),d=Rf(c);d;)Ok(b,d,[]),Pf(c),d=Rf(c);return b}J['application/mp4; codecs="wvtt"']=Qk;}).call(exportTo,innerGlobal,innerGlobal);if(typeof exports!="undefined")for(var k in exportTo.shaka)exports[k]=exportTo.shaka[k];else if(typeof define!="undefined"&&define.amd)define(function(){return exportTo.shaka});else innerGlobal.shaka=exportTo.shaka})();
...
//  if (!this.nativeLegacyWebVRAvailable && !this.nativeWebVRAvailable) {	// donekoi:	embed.js 12008: TypeError: display is undefined
    this.enablePolyfill();
